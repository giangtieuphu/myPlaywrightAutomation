...
export default class HomePage {
    readonly page : Page
    readonly homeURL 
    readonly homePageHeader
    readonly headerTitle
    readonly headerUserArea
    readonly mainMenu
    readonly adminMenuLink
    readonly leaveMenuLink
    readonly perfomanceMenuLink
    readonly dashboardMenuLink
    readonly maintenanceMenuLink
    readonly userDropdownIcon 
    readonly logoutLink
